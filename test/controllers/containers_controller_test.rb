...
class ContainersControllerTest < ActionController::TestCase
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post :create, container: { current_weight: @container.current_weight, initial_weight: @container.initial_weight, lot_id: @container.lot_id, name: @container.name }
    end
  ...
  test "should update container" do
    patch :update, id: @container, container: { current_weight: @container.current_weight, initial_weight: @container.initial_weight, lot_id: @container.lot_id, name: @container.name }
    assert_redirected_to container_path(assigns(:container))
  end
